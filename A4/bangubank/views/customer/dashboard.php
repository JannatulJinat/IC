                    ...
                    <button
                      ...
                      <span
                        ...
                        <span class="font-medium leading-none text-emerald-700"
                          >
                          <?php
                            echo Session::getSessionVariable('name');
                          ?>
                        </span
                        >
                      </span>
              ...
              <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                  <div class="text-base font-medium text-white">
                    <?php echo Session::getSessionVariable('name') ?>
                  </div>
        ...
        <header class="py-10">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">
              Howdy, <?php echo Session::getSessionVariable('name')?>👋
            </h1>
          </div>
        </header>
      </div>
                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <?php
                            foreach ($balanceTransferList as $item){
                          ?>
                      <tr>
                          <td
                          ...
                          <td
                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 sm:pl-0">
                             <?php echo $item['customerEmail'];?>                          </td>
                          <td
